    ...
    <main>
      <section className="banner container-box">
        <div className="banner-block-left" data-aos="fade-up">
          <h1 className="banner-block-left--title heading-primary">
            Attract and retain clients with a professionally designed website.
          </h1>
          ...
          <div className="banner-block-left-trusted">
            <span className="banner-block-left-trusted--small"
              >Ive been trusted by:</span
            >
            <div className="banner-block-left-trusted-logos">
              <Image loading="lazy" src="/assets/trusted/gammasoft.png" alt="Gammasoft" width={100} height={100}/>
              <Image loading="lazy" src="/assets/trusted/aionline.png" alt="aoinline" width={100} height={100}/>
              <Image loading="lazy" src="/assets/trusted/codema.png" alt="Codema" width={100} height={100} />
            </div>
          </div>
        </div>
      ...
      <section className="collaborate container-box">
        <div className="collaborate-wrapper">
          ...
          <h2 className="collaborate-wrapper-heading heading-big" data-aos="fade-up">
            I collaborate with brands, entrepreneurs and agencies to create <span className="underline">memorable</span> 
            <span className="underline">experiences.</span>
          </h2>
          <p className="collaborate-wrapper-text paragraph-primary" data-aos="fade-up" data-aos-delay="50">
            Consider me a creative partner, not just a resource. 
            I bring fresh perspectives and insights to our collaboration, and work with you to achieve your goals.
          </p>
      ...
      <section className="implementation-process container-box">
        <div className="implementation-process-top">
          ...
          <p className="implementation-process-top-text paragraph-primary" data-aos="fade-up" data-aos-delay="50">
        ...
        <div className="implementation-process-list">
          <div className="implementation-process-list-item" data-aos="fade-up">
            <div className="implementation-process-list-item-top">
              <div className="implementation-process-list-item-top-img">
                <Image loading="lazy" src="/assets/horse-icon.svg" alt="" width={100} height={100} />
              </div>
            ...
            <div className="implementation-process-list-item-bottom">
              <p className="implementation-process-list-item-bottom-text paragraph-primary">
                I always make sure to ask the right questions and address the right challenges before designing. 
                This helps me create a design that meets your needs and stands out.
              </p>
            </div>
          </div>
          <div className="implementation-process-list-item" data-aos="fade-up" data-aos-delay="50">
            <div className="implementation-process-list-item-top">
              <div className="implementation-process-list-item-top-img">
                <Image loading="lazy" src="/assets/design-icon.png" alt="" width={100} height={100}/>
              </div>
              <h3 className="implementation-process-list-item-top-text heading-third">Design</h3>
            </div>
            <div className="implementation-process-list-item-bottom">
              <p className="implementation-process-list-item-bottom-text paragraph-primary">
                At the end of this phase, you will have a pixel-perfect design for your app or website. 
                I create prototypes to simulate the final output before starting the project.
              </p>
            </div>
          </div>
          <div className="implementation-process-list-item" data-aos="fade-up" data-aos-delay="100">
            <div className="implementation-process-list-item-top">
              <div className="implementation-process-list-item-top-img">
                <Image loading="lazy" src="/assets/development-icon.png" alt="" width={100} height={100}/>
              </div>
              <h3 className="implementation-process-list-item-top-text heading-third">Development</h3>
            </div>
            <div className="implementation-process-list-item-bottom">
              <p className="implementation-process-list-item-bottom-text paragraph-primary">
                  As a designer who can also code, I can easily work closely with developers from start to finish. 
                  I also do front-end development for web projects. 
              </p>
            </div>
          </div>
          <div className="implementation-process-list-item" data-aos="fade-up" data-aos-delay="150">
            <div className="implementation-process-list-item-top">
              <div className="implementation-process-list-item-top-img">
                <Image loading="lazy" src="/assets/quality-icon.png" alt="" width={100} height={100}/>
              </div>
              <h3 className="implementation-process-list-item-top-text heading-third">Quality assurance
              </h3>
            </div>
            <div className="implementation-process-list-item-bottom">
              <p className="implementation-process-list-item-bottom-text paragraph-primary">
                Regular meetings provide full insight into my design process.
                After developing initial design versions, I conduct user testing to ensure the best solutions for your clients.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="should-work container-box">
        ...
        <div className="should-work-list">
          <div className="should-work-list-item" data-aos="fade-up" data-aos-delay="50">
            <h3 className="should-work-list-item-heading heading-third">
              An enterpreneur
            </h3> 
        ...
        <p className="should-work-end-text" data-aos="fade-up" data-aos-delay="50">
          I understand your products and tailor them to your goals, creating an elegant and eye-catching package. 
          Youll be amazed by the results. Lets create something special and effective together.
        </p>
        <a
        href="about.html"
        ...
        <div className="references-wrapper">
          <div className="references-wrapper-left">
            <h3 className="references-wrapper-left-heading heading-references" data-aos="fade-up">
              We have always enjoyed working with Igor – he brings creative ideas, delivers fast results, and is a pleasure to collaborate with. 
              Overall, our cooperation has been very positive and successful.
            </h3>
      ...
      <section className="cta">
        <div className="cta-wrapper container-box">
          <p className="cta-wrapper-text paragraph-primary" data-aos="fade-up">
            You can reach your dream customers online. Lets create a winning website together and achieve your goals. 
            Its possible and within your reach.
          </p>
          <p className="cta-wrapper-text paragraph-primary" data-aos="fade-up">
            Lets make it happen!
          </p>
      ...
      <section className="short-personal-info container-box">
        <div className="short-personal-info-left">
          ...
          <p className="short-personal-info-left-text paragraph-primary" data-aos="fade-up" data-aos-delay="100">
            Hi, Im Igor Swatowski, a self-taught web designer and programmer who uses the most popular technologies and design tools. 
          </p>
          <p className="short-personal-info-left-text paragraph-primary" data-aos="fade-up" data-aos-delay="150">
            Im passionate about helping creative professionals improve their websites and work processes, and increase their value and success. 
          </p>
          <a
            href="about.html"
      ...
      <section className="cta-second">
        <div className="cta-second-wrapper container-box">
          <p className="cta-second-text paragraph-primary" data-aos="fade-down">
            Share your ideas with me and Ill create a website that is much more efficient and effective for you.
            <br /><br />
