  ...
  return (
    <div className="footer-wrapper-menu">
      <ul className="footer-wrapper-menu-left">
        ...
        <FooterMenuItem href="/packages" data-c="Packages" aria-label="Packages">
          {t.packages}
        </FooterMenuItem>
      ...
      <ul className="footer-wrapper-menu-right">
        ...
        <FooterMenuItem href="https://dribbble.com/IgorSwatowski" target="_blank" rel="noreferrer">
          Dribbble
        </FooterMenuItem>
        <FooterMenuItem href="https://instagram.com/igor.websites" target="_blank" rel="noreferrer">
          Instagram
        </FooterMenuItem>
        <FooterMenuItem
        ...
        <FooterMenuItem href="https://github.com/igorswatowski" target="_blank" rel="noreferrer">
          Github
        </FooterMenuItem>
      </ul>
    </div>
