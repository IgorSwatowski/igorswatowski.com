...
const FooterContact = () => {
  ...
  return (
    <div className="footer-wrapper-contact">
      <h3 className="footer-wrapper-contact-heading heading-fourth">{t.contactInformation}</h3>
      <p className="footer-wrapper-contact-text paragraph-primary">{t.contactInformationText}</p>
