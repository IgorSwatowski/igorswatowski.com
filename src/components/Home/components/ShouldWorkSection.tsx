  ...
  return (
    <section className="should-work">
      <div className="should-work-wrapper container-box">
        <h2 className="should-work-wrapper-heading heading-secondary" data-aos="fade-up">
          {t.weShouldWorkHeading}
        </h2>
        <div className="should-work-wrapper-list">
          <div className="should-work-wrapper-list-item" data-aos="fade-up" data-aos-delay="50">
