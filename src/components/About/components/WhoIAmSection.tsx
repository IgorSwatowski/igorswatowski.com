    ...
    <section className="who-i-am container-box">
      <div className="who-i-am-left">
        ...
        <div className="social-links" data-aos="fade-down" data-aos-delay="70">
          <Link href="https://github.com/IgorSwatowski" target="_blank" rel="noreferrer">
            <svg
              width="22"
              height="23"
              viewBox="0 0 22 23"
          ...
          <Link href="https://instagram.com/igor.websites" target="_blank" rel="noreferrer">
            <Image loading="lazy" src={InstagramIcon} alt="" />
          </Link>
          <Link href="https://facebook/igor.websites" target="_blank" rel="noreferrer">
            <Image loading="lazy" src={FacebookIcon} alt="" />
          </Link>
          <Link href="https://www.linkedin.com/in/igorSwatowski" target="_blank" rel="noreferrer">
